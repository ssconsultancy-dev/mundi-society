...
function App() {
  ...
  const WORDS = ["Building stronger communities through collaboration, innovation, and dedication."];
  ...
  style={{
    backgroundImage: "url('https://images.unsplash.com/photo-1611679447949-4f56fd246b55?q=80&w=1940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')",
  }}
>
  ...
  Welcome To THE MUNDI (S) SELF SUPPORTING CO-OPERATIVE House Building Society Ltd., Mohali
</h1>
